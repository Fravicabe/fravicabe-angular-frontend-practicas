...
export const routes: Routes = [
    ...
    { path: 'client', loadComponent: () => import('../app/client/client-list/client-list.page').then(m => m.ClientListPage)},
    ...
    { path: 'loan', loadComponent: () => import('../app/loan/loan-list/loan-list.page').then(m => m.LoanListPage)}
];